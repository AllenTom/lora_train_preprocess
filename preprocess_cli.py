...
def main():
    ...
    parser.add_argument('--width', action='store',default=512)
    parser.add_argument('--height', action='store',default=512)
    ...
    parser.add_argument('--split_threshold', action='store',default=0.5)
    parser.add_argument('--overlap_ratio', action='store',default=0.2)
    parser.add_argument('--focal_crop', action='store_true')
    parser.add_argument('--focal_crop_face_weight', action='store',default=0.9)
    parser.add_argument('--focal_crop_entropy_weight', action='store',default=0.3)
    parser.add_argument('--focal_crop_edges_weight', action='store',default=0.5)
    parser.add_argument('--focal_crop_debug', action='store_true')
    parser.add_argument('--multicrop', action='store_true')
    parser.add_argument('--multicrop_mindim', action='store',default=None)
    parser.add_argument('--multicrop_maxdim', action='store',default=None)
    parser.add_argument('--multicrop_minarea', action='store',default=None)
    parser.add_argument('--multicrop_maxarea', action='store',default=None)
    parser.add_argument('--multicrop_objective', action='store',default=None)
    parser.add_argument('--multicrop_threshold', action='store',default=None)
